...
module lfric2lfric_face_conserv_c2f_kernel_mod
...
type, public, extends(kernel_type) :: lfric2lfric_face_conserv_c2f_kernel_type
   private
...
end type lfric2lfric_face_conserv_c2f_kernel_type

public :: lfric2lfric_face_conserv_c2f_kernel_code

  ! Generic interface for real32 and real64 types
  interface lfric2lfric_face_conserv_c2f_kernel_code
    module procedure  &
      lfric2lfric_face_conserv_c2f_code_r_single,                             &
      lfric2lfric_face_conserv_c2f_code_r_double
  end interface
...
contains
  ...
  ! R_SINGLE PRECISION
  ! ==================
  subroutine lfric2lfric_face_conserv_c2f_code_r_single(                      &
                                          nlayers,                            &
                                          cell_map,                           &
  ...
  end subroutine lfric2lfric_face_conserv_c2f_code_r_single

  ! R_DOUBLE PRECISION
  ! ==================
  subroutine lfric2lfric_face_conserv_c2f_code_r_double(                      &
                                          nlayers,                            &
                                          cell_map,                           &
                                          ncell_fine_per_coarse_x,            &
                                          ncell_fine_per_coarse_y,            &
  ...
  end subroutine lfric2lfric_face_conserv_c2f_code_r_double

end module lfric2lfric_face_conserv_c2f_kernel_mod
