...
contains
  ...
  subroutine process_physics_prognostics(processor)
    ...
    end if ! end if radiation /= radiation_none
   
    !========================================================================
    ! Fields owned by the microphysics scheme
    !========================================================================

    if (microphysics /= microphysics_none) then
      ! 3D fields, need checkpointing
    ...
    if (orographic_drag /= orographic_drag_none) then
      ! 2D fields, might need checkpointing
      if (boundary_layer == boundary_layer_um .or.                                &
    ...
    if ( boundary_layer /= boundary_layer_none ) then
      ! 2D fields, might need checkpointing
    ...
    if ( convection /= convection_none ) then
      ! 2D fields, might need checkpointing
    ...
    if ( chemistry /= chemistry_none ) then
    ...
    end if  ! if chemistry /= chemistry_none
    !========================================================================
    ! Fields owned by the aerosol scheme
    !========================================================================

    if ( aerosol /= aerosol_none ) then
    ...
    end if ! if aerosol /= aerosol_none
    ...
    end if ! if stochastic_physics /= stochastic_physics_none
